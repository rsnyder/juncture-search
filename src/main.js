...
setBasePath(
  "https://raw.githubusercontent.com//juncture-digital/search/main/src",
);
...
customElements.define(
  ...
  defineCustomElement(EntityCardStack),
);
...
customElements.define(
  "ve-entity-infoboxes",
  defineCustomElement(EntityInfoboxes),
);
...
customElements.define(
  "ve-language-selector",
  defineCustomElement(LanguageSelector),
);
customElements.define("ve-markdown", defineCustomElement(Markdown));
customElements.define(
  "ve-mentioned-entities",
  defineCustomElement(MentionedEntities),
);
...
customElements.define(
  "ve-wikidata-scholarly-articles",
  defineCustomElement(WikidataScholarlyArticles),
);
customElements.define(
  "ve-wikidata-search",
  defineCustomElement(WikidataSearch),
);
...
console.log(
  `version=${process.env.npm_package_version} env=${process.env.NODE_ENV}`,
);
