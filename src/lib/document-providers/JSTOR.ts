...
export class JSTOR extends ArticleProviderBase {
  ...
  async _doQuery() {
    ...
    let searchArgs: any = {
      ...
      content_set_flags:
        "search_article search_chapter pamphlet review research_report mp_research_report_part".split(
          " ",
        ),
      additional_fields:
        "articleType authors contentType doi issue issueFormatted isOpenAccess itemType jcode journal languages no pageCount pages pageRange pageRangeFormatted pubdate pubdateFormatted publisher semanticTerms srcHtml srcHtml1 srcHtml2 title topics_fingerprint vo volume volumeFormatted".split(
          " ",
        ),
    };
