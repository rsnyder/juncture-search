<template>
  <div ref="root">
    <div
      v-if="fetching"
      class="flex w-full items-center justify-center space-x-4 m-4"
    >
      <div
        ...
        >
          ...
          >
            <div class="flex items-center h-5">
              <input
                id="hs-dropdown-item-checkbox-openalex"
                data-provider="OpenAlex"
                name="hs-dropdown-item-checkbox-openalex"
                type="checkbox"
                @click="setProviders"
            ...
            <img
              src="https://www.gitbook.com/cdn-cgi/image/width=24,dpr=2,height=24,fit=contain,format=auto/https%3A%2F%2F2520693015-files.gitbook.io%2F~%2Ffiles%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252FpHVuV3Ib5KXeBKft4Kcl%252Ficon%252FogQFSOcLuYxWvYBhmDaU%252Fopenalex%2520logo%2520twitter.jpg%3Falt%3Dmedia%26token%3D5136a792-47d6-4d18-96eb-2012b55844d0"
              class="ml-4 h-4 w-4"
            />
          ...
          >
            <div class="flex items-center h-5">
              <input
                id="hs-dropdown-item-checkbox-wikidata"
                data-provider="Wikidata"
                name="hs-dropdown-item-checkbox-wikidata"
                type="checkbox"
                @click="setProviders"
                class="border-gray-200 rounded text-blue-600 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:checked:bg-blue-500 dark:checked:border-blue-500 dark:focus:ring-offset-gray-800"
                aria-describedby="hs-dropdown-item-checkbox-delete-description"
          ...
          >
            <div class="flex items-center h-5">
              <input
                id="hs-dropdown-item-checkbox-jstor"
                data-provider="JSTOR"
                name="hs-dropdown-item-checkbox-jstor"
                type="checkbox"
                @click="setProviders"
                class="border-gray-200 rounded text-blue-600 focus:ring-blue-500 dark:bg-gray-800 dark:border-gray-700 dark:checked:bg-blue-500 dark:checked:border-blue-500 dark:focus:ring-offset-gray-800"
                aria-describedby="hs-dropdown-item-checkbox-delete-description"
            ...
            <img
              src="https://about.jstor.org/wp-content/themes/aboutjstor2017/static/JSTOR_Logo2017_90.png"
              class="ml-4 h-4 w-4"
            />
...
watch(articles, () => {
  store.$state.articlesMap = {
    ...articlesMap.value,
    ...Object.fromEntries(articles.value.map((a: Article) => [a.id, a])),
  };
...
function itemSelected(e: any) {
  ...
  let provider = providers.value.find(
    (p) => p.instance.id === selectedArticle.api,
  ).instance;
