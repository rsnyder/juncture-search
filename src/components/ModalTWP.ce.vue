<script setup lang="ts">
  ...
  onMounted(() => {
    isOpen.value = props.open
    console.log(host.value.children[0])
  })
...
<template>
  <div ref="overlayRef">
    ...
    <div v-if="false" ref="modalRef" id="hs-basic-modal" class="hs-overlay hidden w-full h-full fixed top-0 left-0 z-[60] overflow-x-hidden overflow-y-auto">
    ...
    <div ref="modalRef" id="hs-vertically-centered-scrollable-modal" class="hs-overlay hidden w-full h-full fixed top-0 left-0 z-[60] overflow-x-hidden overflow-y-auto">
        ...
        <div class="max-h-full overflow-hidden flex flex-col bg-white border shadow-sm rounded-xl dark:bg-gray-800 dark:border-gray-700 dark:shadow-slate-700/[.7]">
          ...
          <div class="max-h-[50vh] p-4 overflow-y-auto">
            <slot></slot>
