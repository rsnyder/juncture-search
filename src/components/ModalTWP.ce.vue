...
<template>
  <div ref="overlayRef">
    ...
    <div ref="modalRef" id="hs-vertically-centered-scrollable-modal" class="hs-overlay hidden w-full h-full fixed top-0 left-0 z-[60] overflow-x-hidden overflow-y-auto">
        ...
        <div class="w-full max-h-full flex flex-col bg-white border shadow-sm rounded-xl dark:bg-gray-800 dark:border-gray-700 dark:shadow-slate-700/[.7]">
          <div class="flex justify-between items-center py-3 px-4 border-b dark:border-gray-700">
            <h3 class="font-bold text-gray-800 dark:text-white" v-html="title"></h3>
          ...
          <div class="max-h-[50vh] p-4 overflow-x-hidden overflow-y-auto">
            <slot></slot>
          </div>
